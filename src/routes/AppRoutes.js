...
import StudentCircularsView from '../pages/student/StudentCircularsView';
import StudentProfile from '../pages/student/StudentProfile';
import OnlineProgressCard from '../pages/student/OnlineProgressCard';
...
import ManageOnlineClasses from '../pages/admin/ManageOnlineClasses';
import FeeDashboard from '../pages/admin/FeeDashboard';
import ManageStudentFees from '../pages/admin/ManageStudentFees';
...
function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path="/student-dashboard/notices" element={
                <StudentPrivateRoute>
                    <StudentCircularsView />
                </StudentPrivateRoute>
            } />
            ...
            <Route path="/student-dashboard/online-progress" element={
                <StudentPrivateRoute>
                    <OnlineProgressCard />
                </StudentPrivateRoute>
            } />
<Route path="/student-dashboard/online-classes" element={
    <StudentPrivateRoute>
        <OnlineClasses />
    </StudentPrivateRoute>
} />
            ...
            <Route path="/admin-dashboard/manage-attendance" element={
                <AdminPrivateRoute>
                    <ManageAttendancePage />
                </AdminPrivateRoute>
            } />
            <Route path="/admin-dashboard/attendance-dashboard" element={
                <AdminPrivateRoute>
                    <AttendanceDashboard />
                </AdminPrivateRoute>
            } />
            <Route path="/admin-dashboard/monthly-summary" element={
                <AdminPrivateRoute>
                    <MonthlySummaryPage />
                </AdminPrivateRoute>
            } />
            <Route path="/admin-dashboard/manage-circulars" element={
                <AdminPrivateRoute>
                    <ManageCirculars />
                </AdminPrivateRoute>
            } />
            <Route path="/admin-dashboard/manage-online-classes" element={
    <AdminPrivateRoute>
        <ManageOnlineClasses />
    </AdminPrivateRoute>
            } />
